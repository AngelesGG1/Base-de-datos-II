...
INSERT INTO PROYECTOFINAL.Venta (PK_Venta,Fecha,Total,FK_Cliente,FK_Empleado,FK_MetodoPago,FK_Caja) VALUES (4, TO_DATE('08-07-2025', 'DD-MM-YYYY'), 50,4,4,1,4);
INSERT INTO PROYECTOFINAL.Venta (PK_Venta,Fecha,Total,FK_Cliente,FK_Empleado,FK_MetodoPago,FK_Caja) VALUES (5, TO_DATE('08-07-2025', 'DD-MM-YYYY'), 40,5,5,2,5);
INSERT INTO PROYECTOFINAL.Venta (PK_Venta,Fecha,Total,FK_Cliente,FK_Empleado,FK_MetodoPago,FK_Caja) VALUES (6, TO_DATE('08-07-2025', 'DD-MM-YYYY'), 50,6,6,3,6);
INSERT INTO PROYECTOFINAL.Venta (PK_Venta,Fecha,Total,FK_Cliente,FK_Empleado,FK_MetodoPago,FK_Caja) VALUES (7, TO_DATE('08-07-2025', 'DD-MM-YYYY'), 30,7,7,1,7);
INSERT INTO PROYECTOFINAL.Venta (PK_Venta,Fecha,Total,FK_Cliente,FK_Empleado,FK_MetodoPago,FK_Caja) VALUES (8, TO_DATE('08-07-2025', 'DD-MM-YYYY'), 20,8,8,2,8);
INSERT INTO PROYECTOFINAL.Venta (PK_Venta,Fecha,Total,FK_Cliente,FK_Empleado,FK_MetodoPago,FK_Caja) VALUES (9, TO_DATE('08-07-2025', 'DD-MM-YYYY'), 50,9,9,3,9);
INSERT INTO PROYECTOFINAL.Venta (PK_Venta,Fecha,Total,FK_Cliente,FK_Empleado,FK_MetodoPago,FK_Caja) VALUES (10, TO_DATE('08-07-2025', 'DD-MM-YYYY'), 40,10,10,3,10);
